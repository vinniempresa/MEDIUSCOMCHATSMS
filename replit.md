...
- **August 02, 2025**: Implemented "ticket" terminology throughout the PIX payment system. Updated logs, notifications, and postback handling to use "ticket R$ 126,62" instead of generic payment terms. Pushcut notifications now display "🎉Nova Venda PIX" with complete customer data (name, CPF, phone, email), ticket value, transaction details and all system logs use consistent ticket terminology for better tracking and clarity.