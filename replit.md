...
- **August 02, 2025**: Implemented "ticket" terminology throughout the PIX payment system. Updated logs, notifications, and postback handling to use "ticket R$ 138,42" instead of generic payment terms. Pushcut notifications now display "Venda Pendente" with ticket value, transaction details include ticket description, and all system logs use consistent ticket terminology for better tracking and clarity.