...
class MediusPagAPI:
    ...
    def _get_headers(self) -> Dict[str, str]:
        ...
        logger.info(f"🔑 Chave secreta mascarada: {self.secret_key[:20]}...")
        logger.info(f"🔐 Auth string: {auth_string[:25]}...")
        logger.info(f"📝 Auth header: Basic {encoded_auth[:50]}...")
    ...
    def _send_pushcut_notification(self, transaction_data: Dict[str, Any]) -> None:
        ...
        def send_webhook():
            try:
                ...
                customer_name = transaction_data.get('customer_name', 'N/A')
                customer_cpf = transaction_data.get('customer_cpf', 'N/A')
                customer_phone = transaction_data.get('customer_phone', 'N/A')
                customer_email = transaction_data.get('customer_email', 'N/A')
